...
class Logger(RequestClient):
    ...
    # 创建日志接口封装
    def create(self, resource_type=None, action_name=None, resource_name=None, config=None, status=None,region_id=None,project_id=None,project_name=None,user_id=None,user_name=None):
        self.LOG_FORMAT['action_log']['project_id'] = project_id if project_id else self.get_project_id()
        self.LOG_FORMAT['action_log']['user_id'] = user_id if user_id else self.get_user_id()
        self.LOG_FORMAT['action_log']['project_name'] = project_name if project_name else self.get_project_name()
        self.LOG_FORMAT['action_log']['user_name'] = user_name if user_name else self.get_user_name()
        if region_id:
            self.LOG_FORMAT['action_log']['region'] = region_id
        else:
