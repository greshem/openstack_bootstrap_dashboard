...
horizon.network_topology = {
  ...
  init:function() {
    ...
    self.balloonTmpl = null
    self.balloon_deviceTmpl = null;;
    self.balloon_portTmpl = null;
    self.balloon_netTmpl = null;
    self.balloon_instanceTmpl = null;
