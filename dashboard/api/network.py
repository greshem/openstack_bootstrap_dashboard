...
def tenant_floating_ip_list(request,**search_opts):
    return NetworkClient(request).floating_ips.list(**search_opts)
...
def security_group_list(request,**filters):
    return NetworkClient(request).secgroups.list(**filters)


def security_group_get(request, sg_id,**param):
    return NetworkClient(request).secgroups.get(sg_id,**param)
