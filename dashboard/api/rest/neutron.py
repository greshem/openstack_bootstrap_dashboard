...
from dashboard.api.rest import urls
from dashboard.api.rest import utils as rest_utils
...
class Networks(generic.View):
    ...
    def get(self, request):
        ...
        result = api.neutron.network_list_for_tenant(request, tenant_id)[0]
...
class Ports(generic.View):
    ...
    def get(self, request):
        ...
        result = api.neutron.port_list(request, **request.GET)[0]
        return{'items': [n.to_dict() for n in result]}
