...
class Server(base.APIResourceWrapper):
    ...
    """
    _attrs = ['addresses', 'attrs', 'id', 'image', 'links','memory_mb','root_gb','vcpus',
    ...
    def image_name(self):
        ...
        from dashboard.api import glance  # noqa
...
def server_create(request, name, image, flavor, key_name=None, user_data=None,
                  security_groups=None, memory_mb=1024,vcpus=1,root_gb=10,block_device_mapping=None,
                  block_device_mapping_v2=None, nics=None,
                  availability_zone=None, instance_count=1, admin_pass=None,
                  disk_config=None, config_drive=None, meta=None,
                  scheduler_hints=None):
    return Server(novaclient(request).servers.create(
        name, image, flavor, memory_mb=memory_mb,vcpus=vcpus,root_gb=root_gb,userdata=user_data,
...
#             search_opts['limit'] = page_size
    ...
    instances=c.servers.list(True, search_opts)
...
def usage_get(request, tenant_id, start=None, end=None):
