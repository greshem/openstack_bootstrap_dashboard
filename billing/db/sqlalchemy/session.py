...
from billing.db import exception
from billing.common.gettextutils import _  # noqa
...
#               secret=True),
        cfg.StrOpt('connection',
                default='mysql://djw:notpassword@192.168.210.29:3356/$mysql_db?charset=utf8',
                help='The SQLAlchemy connection string used to connect to the '
                    'database',
                deprecated_opts=[cfg.DeprecatedOpt('sql_connection',
                                                  group='DEFAULT'),
...
CONF = cfg.CONF
CONF.register_opts(mysql_db_opts)
...
def set_defaults(sql_connection, mysql_db, max_pool_size=None,
                 max_overflow=None, pool_timeout=None):
    """Set defaults for configuration variables."""
    cfg.set_defaults(database_opts,
                     connection=sql_connection)
    cfg.set_defaults(mysql_db_opts,
                     mysql_db=mysql_db)
