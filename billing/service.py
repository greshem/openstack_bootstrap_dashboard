...
#from billing import baserpc
#from billing import conductor
#from billing import context
#from billing import debugger
from billing import exception
from billing.i18n import _, _LE, _LI, _LW
#from billing import objects
#from billing.objects import base as objects_base
from billing.common import service
#from billing import rpc
#from billing import servicegroup
from billing import utils
#from billing import version
from billing import wsgi
...
service_opts = [
    ...
    cfg.StrOpt('metadata_manager',
               default='billing.api.manager.MetadataManager',
    ...
    cfg.StrOpt('api_billing_listen',
               default="0.0.0.0",
               help='The IP address on which the metadata API will listen.'),
    cfg.IntOpt('api_billing_listen_port',
               default=8080,
               help='The port on which the metadata API will listen.'),
    ...
    cfg.StrOpt('compute_manager',
               default='billing.compute.manager.ComputeManager',
               help='Full class name for the Manager for compute'),
    cfg.StrOpt('console_manager',
               default='billing.console.manager.ConsoleProxyManager',
               help='Full class name for the Manager for console proxy'),
    cfg.StrOpt('consoleauth_manager',
               default='billing.consoleauth.manager.ConsoleAuthManager',
               help='Manager for console auth'),
    cfg.StrOpt('cert_manager',
               default='billing.cert.manager.CertManager',
               help='Full class name for the Manager for cert'),
    cfg.StrOpt('network_manager',
               default='billing.network.manager.VlanManager',
               help='Full class name for the Manager for network'),
    cfg.StrOpt('scheduler_manager',
               default='billing.scheduler.manager.SchedulerManager',
...
#CONF.import_opt('host', 'billing.netconf')
...
#
#        serializer = objects_base.billingObjectSerializer()
#
...
#        :param topic: defaults to bin_name - 'billing-' part
...
#        if not topic:
#            topic = binary.rpartition('billing-')[2]
#        if not manager:
#            manager_cls = ('%s_manager' %
#                           binary.rpartition('billing-')[2])
